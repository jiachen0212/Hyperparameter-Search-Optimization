...
# class PresetLevel_RegNetX_800mf:
    # BACKONE = 'RegNetX_800mf'
    # RESIZE = [768, 1024, 2048]
    # BATCH_SIZE = [6, 4, 2]
    # BASE_ITER = [1000, 2000, 3000]
    # HEAD = 'DeepLabRAHead'
...
def calculate_recommanded_params(dataset, num_classes, preset):
    ...
    num_iter = 50000 if num_iter >= 50000 else num_iter
...
class RoadSegBaseline(BaselineBase):
    DEFAULT_CONFIG = BaselineDefaults.RoadSegBaseline_cfg

    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.kwargs = merge_dict(BaselineDefaults.RoadSegBaseline_cfg, self.kwargs)
